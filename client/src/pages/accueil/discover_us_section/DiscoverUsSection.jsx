...
export default function DiscoverUsSection() {
	return (
		<section aria-labelledby='discover-us-heading' className='relative'>
			<RotatingCircle
				className='-right-0 translate-x-92 -translate-y-32'
				delay='9s'
			/>
			<div className='flex flex-col lg:flex-row items-start lg:items-center mt-42 mb-32 space-x-12'>
				...
				<h1
					id='discover-us-heading'
					className='text-5xl md:text-7xl lg:text-9xl font-manrope'
				>
					NOUS DÉCOUVRIR
				</h1>
			...
			<TeamProfilesGrids />
			<RotatingCircle
				className='left-0 -translate-x-84 -translate-y-256'
				delay='1s'
			/>
		</section>
	);
